...
Блоки кода вставляются через helper-команды шаблона, как рисунки и таблицы,
...
Для прямого ненумерованного кода в приложениях можно использовать окружение \verb|verbatim|.
