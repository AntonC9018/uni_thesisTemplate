...
Язык программирования определяется по расширению имени файла.
Границы сегмента задаются строками с \verb|Segment <имя> begin| и \verb|Segment <имя> end|,
записанными как комментарии на языке исходного файла.
