...
\begin{center}
\textbf{\regularLastFirstName{\authorNameRu}. \docTitleRu{}. Кишинев, \yearOfWriting{}.}
\end{center}

\textbf{к \docTypeRuDatelny{} ``\docTitleRu{}'', студента \authorNameRu{}, группа \uniGroupName{}, программа обучения \programulDeStudiiRu.}
...
\begin{center}
\textbf{\regularLastFirstName{\authorName}. \docTitleRo{}. Chișinău, \yearOfWriting{}.}
\end{center}
...
\begin{center}
\textbf{\regularLastFirstName{\authorName}. \docTitleEng{}. Chișinău, \yearOfWriting{}.}
\end{center}
...
Также можно использовать \verb|\begin{verbatim}|, который переопределен на использование \verb|minted|.
...
ссылка на всё приложение покрывает пронумерованные изображения и таблицы внутри него.
...
а не на индивидуальные картинки изнутри,
