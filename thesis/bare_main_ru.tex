...
\newcommand{\studentTypeRu}{выпускник} % студент / выпускник
...
\begin{tableWithCaption}{pixel_order_table}{Таблица порядка пикселей\\вторая строка в названии\\третья строка}
...
\imageWithCaption{wide.png}{Широкая полоса}

\imageWithCaption{long.png}{Длинная полоса}
...
\section{Пример картинок в приложениях}

\imageWithCaption{cat_1.jpg}{Картинка 1}

\imageWithCaption{cat_2.jpg}{Картинка 2}
