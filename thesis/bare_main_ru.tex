...
\newcommand{\thesisTitleEng}{Thesis Name} % Doar pentru master
\newcommand{\thesisTypeEng}{master thesis}
\newcommand{\programulDeStudiiEng}{master} % licență / master

\newcommand{\authorName}{Nume Prenume} % Fără patronimic
\newcommand{\thesisTitleRo}{Explorarea formatului PNG}
\newcommand{\thesisTypeRoNedefinit}{teză de master} % an / licență / master
\newcommand{\thesisTypeRoDefinit}{teza de master} % an / licență / master
...
\newcommand{\thesisTypeRuPredlozhny}{магистерская работа} % бакалаврская / курсовая
\newcommand{\thesisTypeRuDatelny}{магистерской работе}
...
\textbf{к \thesisTypeRuDatelny{} ``\thesisTitleRu{}'', студента \authorNameRu{}, группа \uniGroupName{}, программа обучения \programulDeStudiiRu.}
...
\textbf{of the \thesisTypeEng{} ``\thesisTitleEng'' of the student \authorName{}, group \uniGroupName{}, \programulDeStudiiEng{} study program.}
