...
\Cref{pixel_order_table} предоставляет пример вставки таблиц с автоматической нумерацией.
...
На \cref{interface_sketch.png} представлен эскиз графического интерфейса.
...
Например, на \cref{wide.png} широкая картинка не выйдет за пределы, 
а \cref{long.png} она не уйдет за страницу.
...
а именно:
\begin{itemize}
  \item \Cref{cat_1} демонстрирует кота номер 1
  \item \Cref{cat_2} демонстрирует кота номер 2
\end{itemize}
