...
% Пояснение использования ИИ, если выбрали "assisted", на румынском
\newcommand{\aiAssistanceExplanationRo}{Am folosit pentru bla}
...
\begin{figure}[!ht]
\centering
\caption{Таблица порядка пикселей\\вторая строка в названии\\третья строка}
...
Например, на \refFigure{wide.png} широкая картинка не выйдет за пределы, 
а \refFigure{long.png} она не уйдет за страницу.
