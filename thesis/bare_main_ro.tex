...
Limbajul de programare este determinat pornind de la extensia numelui fișierului.
Delimitatoarele sunt linii care conțin \verb|Segment <nume> begin| și \verb|Segment <nume> end|,
scrise ca comentarii în limbajul sursă.
