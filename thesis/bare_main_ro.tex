...
\newcommand{\studentTypeRo}{absolvent}
...
\newcommand{\aiAssistanceExplanationRo}{Am folosit pentru bla\\sdfjkllkjfsd\\lkdsfjkfdsjkl\\ksfdkljj}
...
\begin{figure}[!ht]
\centering
  \caption{Tabelul ordonării pixelilor\\a doua linie în titlu\\a treia linie}
...
\section{Exemple de imagini în anexe}

\imageWithCaption{cat_1.jpg}{Imaginea 1}

\imageWithCaption{cat_2.jpg}{Imaginea 2}
