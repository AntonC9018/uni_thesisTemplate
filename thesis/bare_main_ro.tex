...
\newcommand{\thesisTypeRoNedefinit}{teză de master} % an / licență / master. <teză de> se adaugă automat.
\newcommand{\thesisTypeRoDefinit}{teza de master}
...
\textbf{la \thesisTypeRoNedefinit{} ``\thesisTitleRo{}'', a studentului \authorName{}, grupa \uniGroupName{}, programul de studii \programulDeStudiiRo.}
...
De exemplu, în \refFigure{wide.png} o imagine lată nu va depăși limitele paginii,
iar în \refFigure{long.png} nu va ieși în afara paginii.

\imageWithCaption{wide.png}{Bandă lată}

\imageWithCaption{long.png}{Bandă lungă}
